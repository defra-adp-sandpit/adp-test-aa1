...
using Adp.Test.Aa1.Api.AutoMapper;
using Adp.Test.Aa1.Api.Config;
using Adp.Test.Aa1.Api.Extensions;
...
public static class Program
{
    ...
    public static void ConfigureServices(WebApplicationBuilder builder)
    {
        ...
        {
            config.SwaggerDoc("v1", new OpenApiInfo { Title = "Adp.Test.Aa1", Version = "v1" });
        });
