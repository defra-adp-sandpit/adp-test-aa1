...
| APPINSIGHTS_CLOUDROLE        | Role used for filtering metrics | no       |         |       | Set to `adp-test-aa1-local` in docker compose files                                                                |
...
`docker-compose -p adp-test-aa1-test -f docker-compose.yaml -f docker-compose.test.yaml up`
...
`docker-compose -p adp-test-aa1-test -f docker-compose.yaml -f docker-compose.test.watch.yaml up`
